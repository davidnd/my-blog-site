...
<figure className="architecture-diagram" aria-label="Distributed task scheduler architecture">
  <svg viewBox="0 0 1100 620" role="img">
    ...
    <path className="diagram-line" d="M 640 171 C 710 171 750 223 820 223" />
    <path className="diagram-line diagram-muted" d="M 940 136 V 185" />
    <path className="diagram-line" d="M 940 261 V 286 H 505 V 315" />
    <path className="diagram-line" d="M 640 353 H 820" />
    <path className="diagram-line" d="M 940 391 V 430 H 505 V 475" />
    <path className="diagram-line" d="M 370 513 H 280" />
    <path className="diagram-line" d="M 640 513 H 820" />
    <path className="diagram-line" d="M 420 475 C 290 430 250 300 370 230" />

    <text x="940" y="164" className="diagram-label">assigns shards</text>
    <text x="690" y="300" className="diagram-label">promote due jobs</text>
    <text x="740" y="340" className="diagram-label">dispatch</text>
    <text x="690" y="424" className="diagram-label">execute</text>
    <text x="270" y="365" className="diagram-label">retry with backoff</text>
