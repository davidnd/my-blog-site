...
<figure className="architecture-diagram">
  <img src="/images/distributed-task-scheduler.svg" alt="Architecture diagram of a distributed task scheduler showing submission sources, durable timing plane, scanner pool, ready queue, dispatcher, worker pool, audit sink, retries, and dead-letter queue" />
</figure>
